...
class RequestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->to('/')->with('success','Ttem Inserted Succefully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->to('/')->with('success','Ttem updated Succefully');
    }
    ...
    public function destroy($id)
    {
        ...
        if ($success){
            ...
            return redirect()->to('/')->with('error', ' item Could\'t  be deleted');
        }
    }
}
